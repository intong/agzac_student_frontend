      ...
      <Wrapper>
        <BlockTop>
          <TopContent>
            ...
            <TextBoxMiddle>
              사회문제를 해결하는 상품을 개발해주세요!
            </TextBoxMiddle>
            <TextBoxBottom>
              지금까지 4차산업기술을 보유한 미래인재 정보를 확보하고, 다양한
              사회문제를 살펴 보았습니다. 지금부터는 우리 기업이 사회문제를
              해결하는 상품을 개발할 차례입
              <br />
              니다. 확보한 미래인재 정보와 분석한 사회문제를 기반으로 멋진
              상품을 개발해 주세요!
            </TextBoxBottom>
          </TopContent>
        </BlockTop>
            ...
            >
              <LeftBox>
                {prevSelect && (
                  <>
                    <LeftTitle>
                      {sessionStorage.getItem("user")}&nbsp;님이 선택한
                      사회문제의
                      <br />
        ...
        {faqModal === true && selectTab === "social" ? (
          <ModalWrapperFaq>
            <ModalAreaFaq>
              ...
              />
              <TextDiv>
                이전 미션에서 찾아낸 사회문제 키워드 중 상품을 개발해 해결하고자
                하는 키워드 1가지를 선택해주세요
              </TextDiv>
              <HelpArea></HelpArea>
              <TextDiv2>
